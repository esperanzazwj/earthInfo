...
{
    ImU32 out = ((ImU32)IM_F32_TO_INT8_SAT(in.x)) << IM_COL32_R_SHIFT;
...
//IMGUI_API bool ImGui::ListBox(const char * label, int * current_item, bool(*items_getter)(void *data, int idx, const char **out_text), void * data, int items_count, int height_in_items)
//{
